...
var tree = {
    ...
    form_tree_child: function (data) {
        ...
        $.each(data.data, function (i, v) {
            ...
            d.formValue += '<span class="form-tree-inputs" onclick="Tree.check_all_input(this)">\n' +
                ...
                '                        <input name="tree[' + v[data.kid] + '][]" value="' + v[data.pk] + '" type="checkbox" ' + checked + '/>\n' +
    ...
    css: function () {
        ...
        css.href = "/static/js/tree/defaults/common.css";
        icon.href = "/static/js/tree/defaults/treeIcon.css";
